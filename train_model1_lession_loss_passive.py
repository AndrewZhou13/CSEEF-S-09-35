...
with tf.device('/GPU:0'):
    ...
    ########################################################################
    batch_size = 16
    train_img_list = 4* len(glob.glob(f"grid_data/cancer/images_train/*.npy"))
    val_img_list = 4 * len(glob.glob(f"grid_data/cancer/images_validate/*.npy"))
   ...
   #Keras
    ...
    checkpoint_path = 'saved_models/classification_grid_data_collect_cancer_noncancer_mix.hdf5'
