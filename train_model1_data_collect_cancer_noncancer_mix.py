...
with tf.device('/GPU:0'):
    ...
    ########################################################################
    batch_size = 16
    train_img_list = 2* len(glob.glob(f"grid_data/cancer/images_train/*.npy"))
    val_img_list = 2* len(glob.glob(f"grid_data/cancer/images_validate/*.npy"))
   ...
   #Keras
    ...
    model = load_model('saved_models/classification_grid_data_collect_cancer_noncancer_mix.hdf5', 
    ...
    checkpoint_path = 'classification_grid_data_collect_cancer_noncancer_mix.hdf5'
    ...
    my_model = load_model('classification_grid_data_collect_cancer_noncancer_mix.hdf5', 
                        compile=False)
